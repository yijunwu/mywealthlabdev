namespace WealthLab.IndexDefinitions
{
    ...
    public class TsokakisMACDBear : IndexDefinition
    {
        ...
        public override string Description
        {
            get
            {
                return "Tsokakis MACDBear is the inverse of MACDBull, and shows the percentage of symbols whose MACD is below the Signal Line.";
            }
        }
