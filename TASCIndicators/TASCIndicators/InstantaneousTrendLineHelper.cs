namespace TASCIndicators
{
    ...
    public class InstantaneousTrendLineHelper : IndicatorHelper
    {
        ...
        public override Type IndicatorType
        {
            get
            {
                return typeof(InstantaneousTrendLine);
            }
        }
        ...
        public override string URL
        {
            get
            {
                return "http://www2.wealth-lab.com/WL5Wiki/InstantaneousTrendLine.ashx";
            }
        }
    }
}
