namespace WealthLab.Indicators
{
    ...
    public class KeltnerUpperHelper : IndicatorHelper
    {
        ...
        public override string Description
        {
            get
            {
                return "The KeltnerUpper has fixed bands that are plotted above and below a simple moving average of average price.";
            }
        }
        ...
        public override string URL
        {
            get
            {
                return "http://www2.wealth-lab.com/WL5Wiki/KeltnerUpper.ashx";
            }
        }
    }
}
