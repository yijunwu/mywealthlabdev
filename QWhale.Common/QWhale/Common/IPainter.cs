namespace QWhale.Common
{
    ...
    {
        void BeginPaint(System.Drawing.Graphics graphics);
        int CharWidth(char ch, int count);
        int CharWidth(char ch, int width, out int count);
        void Clear();
        void DrawDotLine(int x1, int y1, int x2, int y2, Color color1, Color color2);
        ...
        System.Drawing.StringFormat StringFormat { get; set; }
