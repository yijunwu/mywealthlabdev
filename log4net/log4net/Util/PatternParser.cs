namespace log4net.Util
{
    ...
    public sealed class PatternParser
    {
        ...
        {
            LogLog.Debug(string.Concat(new object[] { "PatternParser: Converter [", converterName, "] Option [", option, "] Format [min=", formattingInfo.Min, ",max=", formattingInfo.Max, ",leftAlign=", formattingInfo.LeftAlign, "]" }));
            ...
            else
            {
                ...
                {
                    LogLog.Error("PatternParser: Failed to create instance of Type [" + type.FullName + "] using default constructor. Exception: " + exception.ToString());
                }
