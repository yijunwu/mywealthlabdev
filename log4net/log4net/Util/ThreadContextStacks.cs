    ...
    public sealed class ThreadContextStacks
    {
        ...
        public ThreadContextStack this[string key]
        {
            get
            {
                ...
                LogLog.Error("ThreadContextStacks: Request for stack named [" + key + "] failed because a property with the same name exists which is a [" + obj2.GetType().Name + "] with value [" + nullText + "]");
