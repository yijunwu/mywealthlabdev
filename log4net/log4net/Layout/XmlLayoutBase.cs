namespace log4net.Layout
{
    ...
    public abstract class XmlLayoutBase : LayoutSkeleton
    {
        ...
        private readonly ProtectCloseTextWriter m_protectCloseTextWriter;
        ...
        {
            this.m_locationInfo = false;
            this.m_protectCloseTextWriter = new ProtectCloseTextWriter(null);
        ...
        public override void Format(TextWriter writer, LoggingEvent loggingEvent)
        {
            ...
            XmlTextWriter writer2 = new XmlTextWriter(this.m_protectCloseTextWriter) {
