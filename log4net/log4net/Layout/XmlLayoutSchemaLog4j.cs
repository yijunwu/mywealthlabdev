namespace log4net.Layout
{
    ...
    public class XmlLayoutSchemaLog4j : XmlLayoutBase
    {
        ...
        protected override void FormatXml(XmlWriter writer, LoggingEvent loggingEvent)
        {
            ...
            TimeSpan span = (TimeSpan) (loggingEvent.TimeStamp.ToUniversalTime() - s_date1970);
            ...
            if (property != null)
            {
                str = loggingEvent.Repository.RendererMap.FindAndRender(property);
            ...
            if (properties.Count > 0)
            {
                ...
                foreach (DictionaryEntry entry in (IEnumerable) properties)
                {
                    ...
                    str = loggingEvent.Repository.RendererMap.FindAndRender(entry.Value);
