namespace WealthLab.ChartDrawingObjects
{
    ...
    public class CDOVerticalLine : CDOLineBased
    {
        private static DrawingObjectHelper drawingObjectHelper_0 = new VerticalLineHelper();
        private LineSettings lineSettings_0;
        private Point point_0;

        public CDOVerticalLine()
        {
            base.ClipToPane = false;
        }

        public CDOVerticalLine(ChartPane pane, DateTime dateTime_0, double value) : base(pane, dateTime_0, value)
        {
        ...
        protected override void Render(Graphics graphics_0)
        {
            if ((base.LeftHandle.Bar != -1) && (base.RightHandle.Bar != -1))
            {
                ...
                graphics_0.DrawLine(pen, base._mover.X, 0, base._mover.X, base.ChartHeight);
                pen.Dispose();
            }
        }
